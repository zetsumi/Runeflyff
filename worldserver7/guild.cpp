...
void tguild::piece(tplayer *p, int dbid)
{
	bool ended=false;
	{
		pmutex::unlocker gm=guildmutex.lock();
...
,nmembers(0),bankmoney(0),nloggedin(0),waring(0),cwing(false),cwtime(0),warpacket(0),warendpacket(0)
,disbanded(false)
{
	{
		pmutex::unlocker gm=guildmutex.lock();
...
:nloggedin(0),nmembers(0),waring(0),cwing(false),disbanded(false)
{
	{
		pmutex::unlocker gm=guildmutex.lock();
